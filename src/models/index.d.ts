...
export declare type Elderly = LazyLoading extends LazyLoadingDisabled
  ? EagerElderly
  : LazyElderly;

export declare const Elderly: (new (
  init: ModelInit<Elderly, ElderlyMetaData>,
) => Elderly) & {
  copyOf(
    source: Elderly,
    mutator: (
      draft: MutableModel<Elderly, ElderlyMetaData>,
    ) => MutableModel<Elderly, ElderlyMetaData> | void,
  ): Elderly;
};
...
export declare type ScheduledItem = LazyLoading extends LazyLoadingDisabled
  ? EagerScheduledItem
  : LazyScheduledItem;

export declare const ScheduledItem: (new (
  init: ModelInit<ScheduledItem, ScheduledItemMetaData>,
) => ScheduledItem) & {
  copyOf(
    source: ScheduledItem,
    mutator: (
      draft: MutableModel<ScheduledItem, ScheduledItemMetaData>,
    ) => MutableModel<ScheduledItem, ScheduledItemMetaData> | void,
  ): ScheduledItem;
};
